 ...
 */
PUBLIC FLT_OR_DBL
vrna_exp_E_mb_loop_fast_pk(vrna_fold_compound_t        *fc,
                        int                         i,
                        int                         j,
                        struct vrna_mx_pf_aux_ml_s  *aux_mx)
{
...
PUBLIC void
vrna_exp_E_ml_fast_rotate_pk(struct vrna_mx_pf_aux_ml_s *aux_mx)
{
  if (aux_mx) {
    int         u;
    FLT_OR_DBL  *tmp;
...
PUBLIC void
vrna_exp_E_ml_fast_free_pk(struct vrna_mx_pf_aux_ml_s *aux_mx)
{
  if (aux_mx) {
    int u;
              ...
              struct vrna_mx_pf_aux_ml_s  *aux_mx)
{
  ...
  if ((fc->aux_grammar))
	qqm[i] += exp_E_pseudoknot_new (fc, i, j);
